...
const SinglePracticeExamResult = () => {
  ...
  let correctAnswerCount = questionsState.questions.filter(
    (ques) => ques.isCorrectAnswered
  ).length;

  let incorrectAnswerCount =
    questionsState.questions.length - correctAnswerCount;
  ...
  return (
    <main className="bg-gray-100 p-3 relative">
      <div className="grid grid-cols-4 gap-2 bg-gray-100">
        {/* SUMMARY OF SCORES */}
        <section
          className="h-[calc(94vh)] bg-white col-span-1
        ...
        >
          ...
          {/* question table  */}
          <div className="mt-12">
            <div className="my-3">Assessment Results</div>
            <div className="justify-start flex flex-col flex-wrap h-96 gap-1.5 p-2">
              {questionsState.questions.map((ques, quesIdx) => (
                ...
                >
                  ...
                  ${currentQuestion === quesIdx && 'bg-zinc-300'}`}
                    onClick={() => setCurrentQuestion(quesIdx)}
                  >
            ...
            {/* Pre-Next buttons */}
            <div className="flex justify-center gap-2 text-gray-600 text-3xl mt-5">
              <button
                className={`${
                  currentQuestion === 0 && 'text-gray-400'
            ...
            <div className="mt-6 flex justify-start italic text-gray-600 text-xs">
              ...
              <div>
                <div className=" items-center  flex">
                  ...
                  <p>or</p>
                  <div
                    className="w-4 h-4 flex items-center justify-center rounded shadow mx-3 bg-gray-100"
                  >
