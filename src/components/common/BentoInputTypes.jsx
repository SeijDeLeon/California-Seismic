...
export const DefaultInput = ({ value, onChange }) => {
    return (
        <input
            ...
            className="rounded border-black p-2 w-1/2 border-b-4 bg-gray-100"
            type="number"
            min="0.01"
            max="100"
            step="0.01"
...
export const CounterInput = ({ value, onChange }) => {
    ...
    return (
        <div className="align-center justify-between flex flex-row items-center">
            <p className="text-2xl font-bold mr-5">{value}</p>
            <div>
                <button
...
export const ListInput = ({ value, listItems, onChange }) => {
    ...
    return (
        <div ref={containerRef} className="relative w-1/2">
            <button
                type="button"
                className="w-full border-b-4 bg-gray-100 border-black rounded px-4 py-2 text-left"
            ...
            {showList && (
                <div className="absolute left-0 top-full mt-1 w-full bg-white border rounded shadow z-10 overflow-y-auto">
